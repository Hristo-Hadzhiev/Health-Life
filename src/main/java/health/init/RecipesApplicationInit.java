    ...
    public void run(String... args) throws Exception {
        if (recipeRepository.count() == 0) {
            ...
            Recipe recipe3 = new Recipe("Салата детокс с киноа и зеленчуци", RecipeEnum.ПРЕДЯСТИЕ,
                    ...
                    80,
                    170,
                    "Нарязвате съставките, след което овкусявате.",
                    240,
            ...
            Recipe recipe4 = new Recipe("Здравословен авокадо тост", RecipeEnum.ВЕГЕТАРИАНСКО,
                   "- 1 голям кръгъл сладък картоф, нарязан по дължина на дълги филийки\n" +
                    ...
                    30,
                    154,
                    "1. Запечете филийките сладък картоф ,като преди това ги поръсите с авокадово масло,\n" +
                            "до придобиване на златиста коричка.\n" +
                            "2. След това декорирайте филийките по желание с яйце , червен лук , чери домати , ягоди.",
                    102,
            ...
            Recipe recipe8 = new Recipe("Мъфини с яйца, спанак и гъби", RecipeEnum.ОСНОВНО,
                    ...
                    60,
                    202,
                    "1. Приготвянето на тези здравословни мъфини за закуска е супер лесно! Започнете с предварително загряване на фурната и разбиване на яйцата в голяма купа.\n" +
                            "2. Нарежете чушките и гъбите на малки парченца и настържете гаудата. След това ги добавете в сместта.\n" +
                            "3. Добавете бейби спанака и разбъркайте леко.\n" +
                            "4. Добавете мащерка и сол на вкус.\n" +
                            "5. Печете във фурната на 180 градуса до готовност.",
                    150,
            ...
            Recipe recipe9 = new Recipe("Супер закуска", RecipeEnum.ОСНОВНО,
                    ...
                    80,
                    145,
                    "1. Прави се от вечерта. Просто се смесват всички съставки и се слагат в хладилника до сутринта.",
                    174,
            ...
            Recipe recipe12 = new Recipe("Здравословен вариант на любимата баклава", RecipeEnum.ДЕСЕРТ,
                    ...
                    "1. Загрейте фурната на 180 градуса\n" +
                            "2. Разтопете маслото, като първо намажете с него съда, в който ще приготвяте баклавата\n" +
                            "3. Сложете три листа от корите, поръсете с разтопеното масло и покрийте с натрошени ядки\n" +
                            "4. Сложете още два листа, като отново покриете с масло и ядки и продължете, докато останат 7 листа\n" +
                            "5. Завършете с последните листи, като мажете всеки от тях с масло\n" +
                            "6. С много остър нож нарежете баклвата на триъгълници\n" +
                            "7. Сложете във фурната и печете за 40-50 минути или до покафеняване\n" +
                            "8. Докато се пече, в малък тиган комбинирайте всички съставки за сиропа\n" +
                            "9. Сложете да ври на средна температура, като разбърквате до разтварянето на захарта, след това намалете печката и оставете да къкри за 3 минути\n" +
                            "10. Махнете от котлона и оставете да се охлади\n" +
                            "11. Когато баклавата е готова, бавно изсипете сиропа върху нея\n" +
                            "12. Поръсете с останалото от натрошените ядки и оставете да попие поне за 5 часа",
                    147,
            ...
            Recipe recipe13 = new Recipe("Сурова веган торта с боровинки", RecipeEnum.ДЕСЕРТ,
                    "- 100 гр. сушени, меки кайсии\n" +
                            ...
                            "За крема:\n" +
                            "\n" +
                            "- 2 чаени чаши кашу, накиснато във вода за 30-40 минути и изплакнато\n" +
                            "- един белен банан\n" +
                            "- 3-4 супени лъжици разтопено кокосово масло\n" +
                            "- 5-6 супени лъжици кленов сироп\n" +
                            "- ¼ чаша овесено мляко или бадемово мляко, ако е необходимо\n" +
                            "- 1 чаена лъжица ванилов екстракт\n" +
                            "- ½ чаша боровинки\n" +
                            "- шепа пресни листа от мащерка",
                    90,
                    320,
                    "1. Пригответе форма с диаметър 18 см. и поставете парче пергаментна хартия в дъното на тортата.\n" +
                            ...
                            "\n" +
                            "2. За крема - смесете всички необходими съставки в блендера (без боровинките и мащерката) и блендирайте до получаване на гладка, " +
                            ...
                            "\n" +
                            "3. Изсипете около 1/3 от сместа върху основата, а към останала смес добавете боровинките и мащерката. " +
                            "Блендирайте и добавете и 2-рата част от крема.\n" +
                            "\n" +
                            "4. Декорирайте с боровинките и мащерката. Поставете тортата във фризера за около 2-3 часа или докато се стегне добре.",
                    147,
            ...
            Recipe recipe14 = new Recipe("Кекс с череши и банани без захар", RecipeEnum.ДЕСЕРТ,
                    ...
                    60,
                    320,
                    "1. Разбивате яйцата и подсладителите на сняг с миксер.\n" +
                            "2. Добавяте брашното и бакпулвера и разбърквате с дървена шпатула бавно и внимателно\n" +
                            "докато стане хомогенно.\n" +
                            "3. Изсипете в тава покрита с хартия за печене и добавете банана и черешите равномерно\n" +
                            "върху сместа .\n" +
                            "4. Печете в предварително загрята фурна на 180 градуса до суха клечка.\n" +
                            "\n" +
            ...
            Recipe recipe15 = new Recipe("Кестеново-тиквена супа", RecipeEnum.ПРЕДЯСТИЕ,
                    ...
                    60,
                    320,
                    "1. Разтопете маслото в голяма тенджера при умерено ниска топлина. Добавете лука," +
                            " тиквата, картофите и кестените, докато зеленчуците омекнат, за около 45 минути. Оставете малко да се охлади.\n" +
                            "\n" +
                            "2. Сложете сместа в кухненския робот до получаване на гладка течност. Подправете със сол и черен пипер." +
